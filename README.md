# Analysis code for biochar paper

This repository contains the analysis codes used in the biochar paper.
...
|---------|-------|
| Games_howell_test.R | This code contains games howell test and its letter markers. |
| Mantel_test_and_spearman_correlation.R | This code performs Spearman correlation analysis and Mantel test, followed by image drawing. |
| PLS_SEM.R | This code performs partial least squares structural equation modeling.  |
